...
namespace LittleLamb.Scripts.Editor
{
  /// <summary>
  ...
  public class SceneBootstrapper
  {
    ...
    const string k_LoadBootstrapSceneOnPlay = "Little Lamb/Load Bootstrap Scene On Play";
    const string k_DoNotLoadBootstrapSceneOnPlay = "Little Lamb/Don't Load Bootstrap Scene On Play";
    ...
    static void EnableLoadBootstrapSceneOnPlay()
    {
      ...
      // Refresh boostrapped scene
      BootstrapScene = EditorBuildSettings.scenes[0].path;
    }
